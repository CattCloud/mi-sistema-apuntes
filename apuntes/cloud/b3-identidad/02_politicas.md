...
> 📝 **ARN** *(Amazon Resource Name)* es la dirección única de cualquier cosa dentro de AWS. Aparece por todas partes sin anunciarse: en la lista de usuarios, cada identidad se muestra como `arn:aws:iam::123456789012:user/cattcloud`. Se lee por partes — servicio, cuenta, tipo de recurso y nombre.
