...
| **`manual_apuntes_cattcloud.md`** (patrones de estilo) | Cómo deben verse y estructurarse los apuntes: arquetipos, jerarquía, voz, tratamiento de código |
...
- El agente propone la estructura (puntos y subsecciones) basándose en:
  ...
  - Los patrones de `manual_apuntes_cattcloud.md`
...
1. `manual_apuntes_cattcloud.md` — finalizado y validado
